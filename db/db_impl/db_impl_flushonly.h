...
class DBImplFlushOnly : public DBImpl {
 public:
  DBImplFlushOnly(const DBOptions& options, const std::string& dbname);
  // No copying allowed
  DBImplFlushOnly(const DBImplFlushOnly&) = delete;
  void operator=(const DBImplFlushOnly&) = delete;

  virtual ~DBImplFlushOnly();
 ...
 private:
  ...
  static Status OpenForFlushOnlyWithoutCheck(
